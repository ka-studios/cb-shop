...
export function Item({
  ...
  if (available === "false") {
    ...
    button = (
      <Button asChild>
        <Link href={buyUri}>Buy</Link>
      </Button>
    )
  }
  if (isMmo) {
    mmo = (
      <p className="font-extralight leading-tight tracking-tighter md:text-xl">
        per 100 levels
      </p>
    )
